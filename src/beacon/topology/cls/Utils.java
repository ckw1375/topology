...
import beacon.topology.estimote.sdk.internal.HashCode;
...
public class Utils
{
   ...
   */
   ...
   public static double computeAccuracy(Beacon beacon)
   {
	   ...
	   double gain = 0;
	   double alpha = 3D;
	   double diff = beacon.getMeasuredPower() - beacon.getRssi() + gain;
	   
	   return Math.pow(10D, diff/(alpha*10D));
   	   
   }
   
   public class movAvgDist {
	   private double dist;
	   private double a;
	   
	   movAvgDist(double init_dist, double a) {
		   this.dist = init_dist;
		   this.a = a;
	   }
	   ...
	   public void reset(double init_dist, double a) {
		   this.dist = init_dist;
		   this.a = a;
	   }
   }
